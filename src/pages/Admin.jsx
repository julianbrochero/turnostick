                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                  ...
                  <div className="divide-y divide-slate-50">
                    {DAYS.map(({ dow, label }) => {
                      ...
                      return (
                        <div key={dow} className="px-4 py-3 flex items-center gap-3">
                          ...
                          <span className={`text-sm font-medium w-24 shrink-0 ${day.is_open ? 'text-slate-900' : 'text-slate-400'}`}>{label}</span>
                          {day.is_open ? (
